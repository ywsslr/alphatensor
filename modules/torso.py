...
from attention import AlphaMultiHeadAttention
...
if __name__ == "__main__":
    ...
    # simulation
    x = torch.randint(-1,1,(batch_size,tensor_length,input_size,input_size,input_size),dtype=torch.float32)
    s = torch.randint(0,10,(batch_size,scalar_size),dtype=torch.float32)
    middle_feature = Torso(x,s)
    print(middle_feature)
    print(middle_feature.shape)