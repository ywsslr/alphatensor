...
def cob_entry_prob_distribution(size):
    """
    生成一个具有特定概率分布的张量，其中每个元素可以是 -1、0 或 1,
    且 0 的概率为 0.985,-1 和 1 的概率各为 0.0075。
    通过均匀分布的随机数和累计概率分布，确定每个元素的值，并返回生成的张量。
    """
...
class ChangeOfBasis:
    ...
    def __init__(
        ...
        Args:
            ...
            random_seed (int, optional): Random seed for reproducibility.
        """
        # self.tmp_dir = "/data1/lr" + "/.data_alpha_tensor/cob_matrices"
        base_dir = "/data1/lr"
        sub_dir = ".data_alpha_tensor/cob_matrices"
        self.tmp_dir = Path(base_dir) / sub_dir
...
if __name__ == "__main__":
    a = cob_entry_prob_distribution((4,4))
    # print(a)
