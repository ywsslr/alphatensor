...
def generate_synthetic_data(
    ...
    for _ in range(n_data):
        ...
        yield output_tensor, list_of_triplets  # yield参数返回生成器
...
if __name__ == "__main__":
    ...
    n_data = 100
    limit_rank = 8
    prob_distr = f_prob_distribution
    random_seed = 42
    x = generate_synthetic_data(tensor_size, n_data, limit_rank, prob_distr, random_seed)
    print(next(x))